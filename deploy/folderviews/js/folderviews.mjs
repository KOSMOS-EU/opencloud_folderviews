...
//#endregion
//#region src/components/TypedFolderToolbar.vue?vue&type=script&setup=true&lang.ts
var _hoisted_1$9 = {
	key: 0,
	class: "typed-toolbar"
};
...
var ResourceTree_default = /*#__PURE__*/ _plugin_vue_export_helper_default(/* @__PURE__ */ __mf_93({
	...
	setup(__props, { emit: __emit }) {
		...
		return (_ctx, _cache) => {
			...
			return __mf_132(), __mf_83$1("div", _hoisted_1$8, [__mf_91$1(TypedFolderToolbar_default, { space: __props.space }, null, 8, ["space"]), __mf_91$1(__mf_55(__mf_89), {
				"selected-ids": [],
...
var ResourceMetro_default = /* @__PURE__ */ __mf_93({
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return __mf_132(), __mf_83$1("div", null, [__mf_91$1(TypedFolderToolbar_default, { space: __props.space }, null, 8, ["space"]), __mf_91$1(__mf_55(__mf_91), __mf_118(_ctx.$attrs, {
	...
	setup(__props, { emit: __emit }) {
		...
		return (_ctx, _cache) => {
			...
			return __mf_132(), __mf_83$1("div", { class: __mf_58(["element-container-wrap", { "element-container-nested": __props.depth > 0 }]) }, [
				__props.folderName ? (__mf_132(), __mf_83$1("div", _hoisted_1$1, [
					...
					__props.depth > 0 ? (__mf_132(), __mf_83$1("button", {
						key: 1,
						class: "element-container-del",
						onClick: __mf_24(deleteContainer, ["stop"])
					}, [__mf_91$1(_component_oc_icon, {
						name: "delete-bin",
						size: "small"
					}), _cache[9] || (_cache[9] = __mf_84("span", null, "del", -1))])) : __mf_82("", true)
				])) : __mf_82("", true),
				editOpen.value && __props.divParams ? (__mf_132(), __mf_83$1("div", {
					...
					__mf_84("label", null, [_cache[15] || (_cache[15] = __mf_90("Gap ", -1)), __mf_168(__mf_84("input", {
						type: "text",
						"onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => editParams.gap = $event),
						placeholder: "8px"
					}, null, 512), [[__mf_21, editParams.gap]])]),
					__mf_84("label", null, [_cache[16] || (_cache[16] = __mf_90("Padding ", -1)), __mf_168(__mf_84("input", {
						type: "text",
				...
				!__props.folderName && !loading.value ? (__mf_132(), __mf_83$1("div", _hoisted_5$1, [__mf_84("button", {
					...
					name: "add",
					size: "small"
				}), _cache[17] || (_cache[17] = __mf_84("span", null, "+md", -1))]), __mf_84("button", {
					class: "element-container-add",
					onClick: __mf_24(createDiv, ["stop"])
				}, [__mf_91$1(_component_oc_icon, {
					name: "add",
					size: "small"
				}), _cache[18] || (_cache[18] = __mf_84("span", null, "+div", -1))])])) : __mf_82("", true),
				__mf_84("div", {
					class: "element-container",
					style: __mf_60(containerStyle.value)
				}, [loading.value ? (__mf_132(), __mf_83$1("div", _hoisted_6, [__mf_91$1(_component_oc_spinner, { size: "small" }), _cache[19] || (_cache[19] = __mf_90(" Laden... ", -1))])) : (__mf_132(true), __mf_83$1(__mf_69, { key: 1 }, __mf_138(visibleChildren.value, (r) => {
...
var ResourceElements_default = /*#__PURE__*/ _plugin_vue_export_helper_default(/* @__PURE__ */ __mf_93({
	...
	setup(__props, { emit: __emit }) {
		...
		return (_ctx, _cache) => {
			const _component_oc_spinner = __mf_140("oc-spinner");
			const _component_oc_icon = __mf_140("oc-icon");
			return __mf_132(), __mf_83$1("div", _hoisted_1, [!ready.value ? (__mf_132(), __mf_83$1("div", _hoisted_2, [__mf_91$1(_component_oc_spinner, { size: "small" }), _cache[0] || (_cache[0] = __mf_90(" Laden... ", -1))])) : rootSchema.value ? (__mf_132(), __mf_83$1(__mf_69, { key: 1 }, [__mf_91$1(TypedFolderToolbar_default, { space: __props.space }, null, 8, ["space"]), __mf_91$1(ElementContainer_default, {
				...
				"div-params",
				"space"
			])], 64)) : (__mf_132(), __mf_83$1("div", _hoisted_3, [(__mf_132(true), __mf_83$1(__mf_69, null, __mf_138(filteredResources.value, (r) => {
				return __mf_132(), __mf_83$1("div", {
					key: r.id,
					class: "element-card",
