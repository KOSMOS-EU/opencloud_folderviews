const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["../assets/folderviews-BXN3QdTN.css"])))=>i.map(i=>d[i]);
...
//#endregion
export { virtual_mf_exposes___mfe_internal__folderviews__remoteEntry_mjs_default as default };
